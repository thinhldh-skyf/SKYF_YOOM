  ...
  return (
    <section className="flex gap-4 shadow-sm shadow-white w-full flex-col justify-between rounded-[14px] bg-dark-1 px-5 py-8 xl:max-w-[568px] hover:shadow-md hover:shadow-white transition-all cursor-pointer">
      <article className="flex flex-col gap-2">
        <Image src={icon} alt="cuộc họp" width={28} height={28} />
      ...
      <article
        className={cn("flex flex-wrap gap-6 justify-start relative", {})}
      >
        ...
        {!isPreviousMeeting && (
          <div className="flex gap-4 flex-wrap md:flex-nowrap">
            <Button
              onClick={handleClick}
              variant="default"
              className="group flex-1 capitalize bg-primary-400 hover:bg-black hover:text-white"
            >
              {buttonIcon1 && (
            ...
            <Button
              ...
              variant="outline"
              className="flex-1 capitalize border-0
