...
export const EmailTemplate = ({ firstName }: { firstName: string }) => {
  ...
  return (
    ...
    //       {useUser.firstName} vous a invité à rejoindre une réunion sur <span ClassName="font-semibold ">SKYFTutor</span>.
    //     </p>
    ...
    //       Cet couriel est envoyé à <a href="#" ClassName="text-blue-600 hover:underline dark:text-blue-400" target="_blank">contact@SKYFTutor.com</a>.
    ...
    //     <p ClassName="mt-3 text-gray-500 dark:text-gray-400">© {date} - {time} SKYFTutor. Tous droits réservés.</p>
    //   </footer>
    // </section>
    <h1>hello</h1>
  );
